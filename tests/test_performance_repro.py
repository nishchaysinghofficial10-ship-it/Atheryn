"""Replay and performance-reproducibility regression cases.
...
backward compatibility with schema-1 results written by ATHERYN <= v1.1.
"""
import copy
import json
import shutil
...
from atheryn import stats                                       # noqa: E402
    ...
    def test_environment_metadata_is_stored_for_every_experiment(self):
        ...
        for rec in st.experiments.values():
            ...
            for key in ("python_version", "python_implementation", "system",
                        "machine", "cpu_count", "atheryn_version",
