"""Checks that graphbench uses the same domain-neutral core.

The point of a second domain is not "more features" — it is a check on whether
ATHERYN's core is genuinely domain-agnostic. These tests assert both: that
...
from atheryn.domains import graphbench as G                    # noqa: E402
from atheryn.domains.base import get_domain                    # noqa: E402
from atheryn.models import EpistemicStatus                     # noqa: E402
from atheryn.replay import ReplayPolicy, compare_results       # noqa: E402
...
class TestDomainNeutrality(unittest.TestCase):
    ...
    def test_core_modules_do_not_mention_a_specific_domain(self):
        root = Path(__file__).resolve().parents[1] / "atheryn"
