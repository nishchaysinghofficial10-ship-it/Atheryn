"""Offline tests for retrieval policy and web-evidence provenance.
...
from atheryn import retrieval as R                             # noqa: E402
from atheryn import web_evidence as W                          # noqa: E402
from atheryn.brain import Brain, BrainError                    # noqa: E402
...
class TestCliAndFixtures(unittest.TestCase):
    ...
    def test_cli_refuses_a_policy_violating_url(self):
        from atheryn.cli import main as cli_main
        root = self.tmp / "m"
