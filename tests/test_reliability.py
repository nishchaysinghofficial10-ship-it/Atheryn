"""Hard-interruption, checkpoint, and replay reliability checks."""
import json
import os
import signal
import subprocess
...
from atheryn.state import CheckpointCorrupted, ResearchState   # noqa: E402
...
class TestInterruptionRecovery(unittest.TestCase):
    ...
    def test_sigkill_midrun_then_resume_without_loss_or_duplication(self):
        ...
        proc = subprocess.Popen([sys.executable, "-m", "atheryn", "run",
