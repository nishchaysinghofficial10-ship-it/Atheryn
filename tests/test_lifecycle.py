"""Regression cases for mission transitions, pauses, and terminal states."""
import sys
import tempfile
import unittest
...
from atheryn import lifecycle as lc                            # noqa: E402
...
def make_state(tmp, name="p", profile="fast"):
