"""Regression cases for copied projects and host-dependent timings.

P-1: ATHERYN <= v1.0 stored ABSOLUTE experiment-artifact paths. A copied or
...
from atheryn.cli import main as cli_main                       # noqa: E402
...
class TestArtifactReferencesAreRelative(unittest.TestCase):
    ...
    def test_legacy_absolute_dirs_are_normalized_on_load(self):
        ...
        foreign = "/home/someone-else/atheryn-project/runs/m"  # portability-allow
...
class TestRelocatedMission(unittest.TestCase):
    ...
    def setUp(self):
        self._td = tempfile.TemporaryDirectory()
        self.tmp = Path(self._td.name)
        self.atheryn_mission = self.tmp / "original"
        _completed_mission(self.atheryn_mission)
    ...
    def test_copied_mission_verifies_and_replays(self):
        ...
        shutil.copytree(self.atheryn_mission, copy)
    ...
    def test_copy_without_its_own_artifacts_fails_verify(self):
        ...
        self.assertEqual(ResearchState.load(self.atheryn_mission).verify(), [])
