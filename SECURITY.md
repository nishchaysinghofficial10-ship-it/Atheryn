...
survives `atheryn verify`; autonomy acting beyond its granted authority; reports
...
## What ATHERYN already assumes

- The operator is trusted; the machine isn't multi-tenant.
...
ATHERYN is a computational-research engine. Do not use it for medical, legal,
financial or safety-critical conclusions. Retrieve only sources you are
permitted to retrieve; ATHERYN honours `robots.txt` but does not interpret terms
