"""Shortest-path experiments used as ATHERYN's second domain.
...
ways that stress the core rather than flatter it:
  ...
  * there is a **machine-independent** primary metric — edge relaxations —
    ...
    hostage to the host. Here ATHERYN can state a claim that transfers.
...
RUNNER_TEMPLATE = '''"""Auto-generated by ATHERYN (graphbench domain). Self-contained experiment.
    ...
    def analyze(self, record, result: dict, state) -> dict:
        ...
        for hid in record.hypothesis_ids:
            ...
            for pr in h.predictions:
                ...
                # inside f-strings are PEP 701 (Python 3.12+), and ATHERYN's
