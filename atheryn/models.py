"""Dataclasses for the facts, guesses, experiments, and provenance ATHERYN stores.
...
principle in the ATHERYN specification.
"""
...
class EpistemicStatus(str, Enum):
    ...
    EXPERIMENTAL_RESULT = "experimental_result"  # produced by ATHERYN's own experiments
...
class ExperimentRecord:
    ...
    def path(self, root) -> Path:
        ...
        unpacked anywhere. Absolute values written by ATHERYN <= v1.0 are still
