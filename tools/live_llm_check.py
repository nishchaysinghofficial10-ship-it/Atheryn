#!/usr/bin/env python3
"""A deliberately small live-provider smoke test.
...
Nothing here bypasses ATHERYN: the mission runs through the normal controller,
...
from atheryn.brain import BrainConfigError, make_brain          # noqa: E402
from atheryn.budget import Budget                               # noqa: E402
from atheryn.cli import PROFILES, _brain_logger                 # noqa: E402
from atheryn.controller import ResearchController               # noqa: E402
from atheryn.domains.base import get_domain                     # noqa: E402
from atheryn.proposals import ProposalAudit                     # noqa: E402
...
def main(argv=None) -> int:
    ...
    print("\nEvery conclusion above was produced by ATHERYN's experiment, critic "
