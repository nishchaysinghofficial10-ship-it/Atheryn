#!/usr/bin/env python3
"""A bounded demonstration of the evidence-acquisition path.

Question:
    What source-backed conditions are commonly associated with algorithmic
    performance tradeoffs, and which of those claims can ATHERYN test in its own
...
another — the last section prints which claims ATHERYN could actually test in
...
from atheryn import web_evidence as W                          # noqa: E402
...
from atheryn.retrieval import (PolicyViolation, RetrievalPolicy,  # noqa: E402
...
QUESTION = ("What source-backed conditions are commonly associated with "
            ...
            "ATHERYN test in its own controlled benchmark domain?")
...
def main(argv=None) -> int:
    ...
    print("Every claim above is SPECULATION with a stored passage. None of it "
          "is a finding: only an ATHERYN experiment can produce one.")
    return 0
