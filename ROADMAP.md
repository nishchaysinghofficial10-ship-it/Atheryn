...
This is a working sequence rather than a promise of delivery dates; items move when the evidence or risk changes.
...
1. **Phase 2a — local ingestion.** Feed ATHERYN PDFs/notes/datasets from
...
7. **Phase 8 — ORB.** 20–50 budgeted, experimentally checkable problems;
   compare ATHERYN vs one-shot answers vs fixed pipelines.
