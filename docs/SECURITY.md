# ATHERYN v1.0 — Safe Use

The boundaries below are intentionally specific about what ATHERYN can and cannot enforce by itself.
...
## What ATHERYN does NOT protect against (v1.0)
...
4. **Anything ATHERYN never does**: it does not fetch the web, install packages,
...
automatically. A crash mid-action is recorded as `interrupted` — ATHERYN does not
...
- Do not use ATHERYN for medical, legal, financial, or safety-critical
