# ATHERYN v1.5 — Autonomy Verification Report
...
$ python3 tools/autonomy_demo.py --dir /tmp/atheryn-autonomy-demo
… Web claims stayed SPECULATION; every Evidence item came from an ATHERYN experiment.

$ python3 -m atheryn verify --dir /tmp/atheryn-autonomy-demo
State verified: counts, references, experiment artifacts and event log are consistent.

$ python3 -m atheryn verify --dir examples/autonomy_demo
State verified: counts, references, experiment artifacts and event log are consistent.
