# ATHERYN — Web Evidence Baseline Audit (before v1.4)

These figures describe one recorded run; repeat the cited command before treating them as current on another machine.

Method: inspection of `atheryn/evidence.py` (86 lines), `models.Source`,
`models.Claim`, `atheryn/graph.py`, `atheryn/proposals.py`, `atheryn/brain.py`,
