...
This is the maintainer-facing release note. Commands and packaged artifacts remain the final check.
...
| 2 | Install | *(none required)* `python3 -c "import atheryn"` | imported with zero installs, v2.0.0 |
...
| 5 | Inspect a dossier | `atheryn report --dir runs/demo` | all sections present incl. prediction ledger, falsification, threats to validity |
