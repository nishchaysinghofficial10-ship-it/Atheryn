...
for a human to resolve, never guessed. No novelty is claimed — ATHERYN
...
python -m atheryn init "Which sorting strategy wins where?" --dir runs/demo --profile fast
