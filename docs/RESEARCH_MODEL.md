# ATHERYN v1.0 — Research Model

The model below is intentionally conservative: uncertainty stays visible until an experiment changes it.
...
EXPERIMENTAL_RESULT    produced by ATHERYN's own measurements
...
## Novelty policy
ATHERYN may synthesize candidates (the hybrid sorter, the cutoff-sweep
