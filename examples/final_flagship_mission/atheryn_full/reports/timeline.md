...
DAY 1 — 13:31:45  [experiment_proposal]
    prop_e31021938f: candidate design accepted (algorithms=['dijkstra_heap', 'dijkstra_array', 'bellman_ford', 'spfa', 'bfs_unit'], regimes=['sparse_random', 'dense_random']); ATHERYN sets seed, timeout and scope at execution time
