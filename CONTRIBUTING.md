# Contributing to ATHERYN

Small, reviewable changes are easiest to trust. Include the test or recorded check that supports each behavioral claim.
...
```bash
git clone <repo> && cd atheryn-project
...
`docs/DECISIONS.md`; "convenience" isn't a justification.
